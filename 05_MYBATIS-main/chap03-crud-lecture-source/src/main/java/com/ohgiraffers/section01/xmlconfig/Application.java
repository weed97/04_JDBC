...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.print("============= 오지라퍼 메뉴 관리 시스템 =============");
            System.out.print("1. 메뉴 전체 조회하기 : ");
            System.out.print("2. 메뉴 코드로 메뉴 조회하기 :");
            System.out.print("3. 신규 메뉴 등록하기 : ");
            System.out.print("4. 메뉴 수정하기 : ");
            System.out.print("5. 메뉴 삭제하기 : ");
...
//                case 1: menuController.selectAllMenu(); break;
    ...
    private static Map<String, String> inputMenu(){
        ...
        parameter.put("categoryCode",categoryCdoe);
