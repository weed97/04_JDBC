...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 
        * 데이터 형변환이 필요한 이유
        * - 자바에서 다른 타이끼리의 연산은 피연산자들이 모두 같은 타입인 경우 실행 할 수 있다.
        ...
        * 2. 강제형변환 (명시적 형변환) :  형변환(cast) 연산자를 이용한 경제적으로 수행하는 타입 변환
...
//      /* 작은 자료형에서 큰 자료형으로 공간만 옮기는 경우*/
        ...
        // int result1 = num1 + num2; // 자동으로 큰 자료형인 long으로 변경해서 연산이 되기 때문에 int로 선언된 변수에 값을 담을 수 없다.
...
//        float result = fnum + dnum;
//        double result2 = fnum + dnum;
        /*
        정수를 실수로 변경할 때, 소수점 자리가 없어도 실 수 형태처럼 표현이 가능하다.
        ...
        * */
        ...
        char ch1 = 'a';
        int charNamebar = ch1; // 자동형변환됨

        System.out.println("charNamebar = " + charNamebar);
        
        /* int로 type이 명시적으로 정하지 않은 리터럴형태의 정수는 char 형 변수에 기록 가능하다.*/
        char ch2 = 65;
