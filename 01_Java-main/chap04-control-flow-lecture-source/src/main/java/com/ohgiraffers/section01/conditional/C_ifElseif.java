...
public class C_ifElseif {
    ...
    * 조건식1이 false이면 조건식 2를 확인하며 참(true)이면 else if { } 안에있는 코드를 실행한다.
    ...
    * */
    ...
    public void testSimpleleftElseIfStatement() {
        /*System.out.println("산 속에서 나무를 하던 나무꾼이 연못에 도끼를 빠뜨리고 말았다. ");
        System.out.println("연못에서 산신령이 나타나 금도끼, 은도끼, 쇠도끼를들고 나타났다 ");
        System.out.println("나무꾼에게 셋 중 어떤 도끼가 나무꾼의 도끼인지 물어보았다");

        System.out.println("어느 도끼가너의 도끼이냐? (1.금도끼, 2. 은도끼, 3.쇠도끼");

        Scanner sc = new Scanner(System.in);
        int answer = sc.nextInt(); // 1,2,3 중에 받아온다.

        if(answer == 1) {
            System.out.println("이런 거짓말쟁이!! 너에게 아무런 도끼도 줄 수 없구나, 이 욕심쟁이야!");

        }   else if(answer == 2){
            System.out.println("욕심이 과하지는 않지만, 넌 거짓말을 하구 있구나!! 어써 썩 사라지거라");
        }
            else if(answer == 3){
            System.out.println("오호 ~ 정직하구나 금도끼, 은도끼, 쇠도끼다 가져가거라~");
        ...
        switch (answer) {
            ...
            case 3 :
                System.out.println("오호 ~ 정직하구나 금도끼, 은도끼, 쇠도끼 가져가거라~ ");
