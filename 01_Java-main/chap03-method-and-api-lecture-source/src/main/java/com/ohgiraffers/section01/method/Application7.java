...
public class Application7 {
    public static void main(String[] args) {
        ...
        System.out.println("두수를 더한 결과 : " + app7.minusTwoNumber(first,second));
        System.out.println("두수를 더한 결과 : " + app7.multipleTwoNumber(first,second));
        System.out.println("두수를 더한 결과 : " + app7.divideTwoNumber(first,second));
    }
