...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 논리 연산자의 종류
         * 1. 논리 연결 연산자
         *   두개의 피연산자를 가지는 이항 연산자이며, 연산자의 결합 방향은 왼쪽에서 오른쪽이다.
         *   두개의 논리 식을 판단하여 참과 거짓을 판단한다.
         *   1-1. &&(논리 AND) 연산자 :
         *       -두 개의 논리식 모두 참 일 경우 True 반환
         *       -둘 중 한개라도 거짓인 경우 False를 반환하는 연산.
         *   1-2. ||(논리 OR) 연산자 :
        ...
        System.out.println("true와 true의 논리 and 연산 : " + (true && false)); //false
        ...
        System.out.println("true와 true의 논리 or 연산 : " + (true || false)); //true
        ...
        System.out.println();
        System.out.println("=========== 논리식에 AND 연산자 활용 ===========");
        System.out.println("a가 b보다 작으면서 c가 d보다 작은 확인 :" + (a < b && c < d)); // true
        ...
        System.out.println();
        System.out.println("=========== 논리식에 or 연산자 활용 ===========");
        ...
        System.out.println("a가 b보다 크거나 c가 d보다 작은지 확인 : " + (a > b  || c > d)); // false
