    ...
    * */
    ...
    public void testMethod(int num) {
        ...
        * */
        ...
        System.out.println(num); // 매개변수는 호출시 값이 넘어와서 변경되기 떄문에 초기화가 필요없다.
    ...
    public void testMethod() {
        ...
        // System.out.println(localNUM); // 지역 변수는 해당 지역(블록)안에서만사용 가능하다.
        System.out.println(globalNum);  // 전역 변수는 다른 메소드에서도 사용가능하다.
