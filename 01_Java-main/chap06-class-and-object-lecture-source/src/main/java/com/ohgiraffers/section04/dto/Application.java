...
public class Application {
    public static void main(String[] args) {
        ...
        *       호출 시 인자가 많아지는 경우 어떠한 값이 어떤 필드를 의미하는지 한 눈에 보기 어렵다.
        ...
        *       예) 아이디, 비밀번호, 이름이 모드 ohgiraffers 인 경우
        *       User user = new User();
        ...
        * */
        ...
        // 1. 생성자를 이용한 초기화
        UserDTO user1 = new UserDTO("ohgiraffers", "ohgiraffres","ohgiraffers", new java.util.Date());
